const translations: Record<string, Record<string, string>> = {
  en: {
    ...
    'settings.claudePermissionMode': 'Claude Permission Mode',
    'settings.claudePermissionAcceptEdits': 'acceptEdits (recommended)',
    'settings.claudePermissionDefault': 'default (ask when needed)',
    'settings.claudePermissionDontAsk': 'dontAsk (deny protected actions)',
    'settings.claudePermissionPlan': 'plan (planning only)',
    'settings.claudePermissionBypass': 'bypassPermissions (unsafe)',
  ...
  zh: {
    ...
    'settings.transparencyWeak': '低',
    'settings.transparencyStrong': '强',
    'settings.langEn': 'English',
    'settings.langZh': '中文',
    ...
    'settings.claudePermissionMode': 'Claude 权限模式',
    'settings.claudePermissionAcceptEdits': 'acceptEdits（推荐）',
    'settings.claudePermissionDefault': 'default（按需询问）',
    'settings.claudePermissionDontAsk': 'dontAsk（拒绝受限操作）',
    'settings.claudePermissionPlan': 'plan（仅规划）',
    'settings.claudePermissionBypass': 'bypassPermissions（不安全）',
